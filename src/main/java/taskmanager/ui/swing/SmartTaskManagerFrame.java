...
setMinimumSize(new Dimension(1000, 600));
    ...
    private JPanel buildNorthPanel() {
        ...
        // ---- Button row ----
        JPanel buttons = new JPanel(new FlowLayout(FlowLayout.LEFT, 15, 8));
        ...
        // ---- Search row ----
        JPanel searchRow = new JPanel(new FlowLayout(FlowLayout.LEFT, 15, 10));
    ...
    private JPanel buildInfoPanel() {
        ...
        recArea.setFont(new Font("SansSerif", Font.PLAIN, 14));
        recArea.setBackground(new Color(0xF1F8E9));
